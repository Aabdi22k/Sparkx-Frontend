  ...
  return (
    <div className="bg-white  dark:bg-black h-screen w-full flex flex-row dark:text-white text-black">
      ...
      <div className=" w-1/2 hidden lg:flex justify-center items-center">
        <img src={loginimage} alt="cool stuff" />
      </div>
      <div className=" lg:w-1/2 w-full flex flex-col justify-center items-center gap-16">
        ...
        <div className="flex flex-row justify-center items-center gap-4 lg:gap-8 ">
          <Tooltip text={"Apple Login"} position="bottom">
            <div className="border-2 border-neutral-300 dark:border-neutral-600 bg-neutral-100 dark:bg-neutral-900  rounded-xl p-4 ">
              <IconBrandAppleFilled />
            </div>
          </Tooltip>
          <Tooltip text={"Github Login"} position="bottom">
            <div className="border-2 border-neutral-300 dark:border-neutral-600  bg-neutral-100 dark:bg-neutral-900  rounded-xl p-4 ">
              <IconBrandGithubFilled />
            </div>
          </Tooltip>
          <Tooltip text={"Google Login"} position="bottom">
            <div className="border-2 border-neutral-300 dark:border-neutral-600  bg-neutral-100 dark:bg-neutral-900  rounded-xl p-4 ">
              <IconBrandGoogleFilled />
            </div>
          </Tooltip>
          <Tooltip text={"Meta Login"} position="bottom">
            <div className="border-2 border-neutral-300 dark:border-neutral-600  bg-neutral-100 dark:bg-neutral-900  rounded-xl p-4 ">
              <IconBrandMeta />
            </div>
          </Tooltip>
        ...
        <form className="flex w-full flex-col justify-center items-center gap-8">
          <div className="flex w-full flex-col justify-center items-center gap-8">
            <input
              className="w-[320px] lg:w-[400px] p-4 rounded-xl outline-none border-neutral-300 dark:border-neutral-600 border-2 bg-neutral-100 dark:bg-neutral-900 dark:placeholder:text-neutral-400 placeholder:text-neutral-600"
              id="username"
              type="text"
              value={username}
          ...
          <div className="flex w-full flex-col justify-center items-center gap-4">
            <button
              ...
              className="cursor-pointer w-[320px] lg:w-[400px] px-6 p-3 rounded-xl text-white text-center bg-crimson"
            >
              Login
            </button>
            <p className="text-sm text-neutral-600 dark:text-neutral-400">
              Don't Have an Account{" "}
              <Link to={"/signup"} className="text-crimson">
                Sign Up
              </Link>
            </p>
          </div>
